...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _strings = new()
    {
        ...
        ["settings.test_notification"] = new() { ["en"] = "Test",     ["ne"] = "परीक्षण" },
        ...
        ["dayinfo.delete"] = new() { ["en"] = "Delete", ["ne"] = "मेटाउनुहोस्" },
        ...
        ["banking.emi_start_date_ad"]  = new() { ["en"] = "Start Date (AD)",               ["ne"] = "सुरु मिति (इ.सं.)" },
        ["banking.emi_error_start_date"] = new() { ["en"] = "Enter start date as YYYY/MM/DD (BS)", ["ne"] = "सुरु मिति YYYY/MM/DD (बि.सं.) मा हाल्नुहोस्" },
        ["banking.emi_error_start_date_ad"] = new() { ["en"] = "Enter start date as yyyy-MM-dd (AD)", ["ne"] = "सुरु मिति yyyy-MM-dd (AD) मा हाल्नुहोस्" },
        ...
        ["reminder.recurrence_yearly"] = new() { ["en"] = "Yearly",                      ["ne"] = "वार्षिक" },
        ...
        ["hint.reminder_notes"]        = new() { ["en"] = "Optional notes...",            ["ne"] = "वैकल्पिक नोट..." },
        ...
        // ── Documents tab ─────────────────────────────────────────────────────────────
        ["docs.heading"]          = new() { ["en"] = "Documents",                                          ["ne"] = "कागजातहरू" },
        ["docs.no_docs"]          = new() { ["en"] = "No documents yet",                                   ["ne"] = "अझै कुनै कागजात छैन" },
        ["docs.no_docs_hint"]     = new() { ["en"] = "Add your important documents for quick access",     ["ne"] = "छिटो पहुँचको लागि आफ्ना महत्त्वपूर्ण कागजातहरू थप्नुहोस्" },
        ["docs.add"]              = new() { ["en"] = "Add Document",                                    ["ne"] = "कागजात थप्नुहोस्" },
        ["docs.form_title_add"]   = new() { ["en"] = "New Document",                                      ["ne"] = "नयाँ कागजात" },
        ["docs.form_title_edit"]  = new() { ["en"] = "Edit Document",                                     ["ne"] = "कागजात सम्पादन" },
        ["docs.browse"]           = new() { ["en"] = "Browse",                                            ["ne"] = "ब्राउज" },
        ["docs.open"]             = new() { ["en"] = "Open file",                                         ["ne"] = "फाइल खोल्नुहोस्" },
        ["docs.file_not_found"]   = new() { ["en"] = "File not found on disk",                            ["ne"] = "फाइल भेटिएन" },
        ["docs.title_required"]   = new() { ["en"] = "Title is required",                                 ["ne"] = "शीर्षक आवश्यक छ" },
        ["docs.no_file_hint"]     = new() { ["en"] = "No file selected",                                  ["ne"] = "कुनै फाइल चयन गरिएको छैन" },
        ["docs.file_required"]    = new() { ["en"] = "A file is required",                                 ["ne"] = "फाइल आवश्यक छ" },
        ["docs.no_results"]       = new() { ["en"] = "No results",                                        ["ne"] = "कुनै नतिजा छैन" },
        ["docs.field_title"]      = new() { ["en"] = "Title",                                             ["ne"] = "शीर्षक" },
        ["docs.field_tags"]       = new() { ["en"] = "Tags",                                              ["ne"] = "ट्यागहरू" },
        ["docs.field_file"]       = new() { ["en"] = "File",                                              ["ne"] = "फाइल" },
        ["docs.field_notes"]      = new() { ["en"] = "Notes (optional)",                                  ["ne"] = "टिप्पणी (ऐच्छिक)" },
        ["docs.clear_file"]       = new() { ["en"] = "Remove file",                                       ["ne"] = "फाइल हटाउनुहोस्" },
        ["docs.search_hint"]        = new() { ["en"] = "Search... or #tag to filter by tag",                ["ne"] = "खोज्नुहोस्... वा #ट्याग" },
        ["docs.duplicate_title"]    = new() { ["en"] = "A document with this title already exists",            ["ne"] = "यो शीर्षकको कागजात पहिले नै छ" },
        ["notes.add"]                    = new() { ["en"] = "Add Note",                  ["ne"] = "नोट थप्नुहोस्" },
        ["notes.search_hint"]            = new() { ["en"] = "Search notes...",              ["ne"] = "नोट खोज्नुहोस्..." },
        ["notes.no_results"]             = new() { ["en"] = "No notes match your search",   ["ne"] = "खोजसँग मिल्ने नोट भेटिएन" },
        ["notes.form_title_add"]         = new() { ["en"] = "Add Note",                     ["ne"] = "नोट थप्नुहोस्" },
        ["notes.form_title_edit"]        = new() { ["en"] = "Edit Note",                    ["ne"] = "नोट सम्पादन गर्नुहोस्" },
        ["notes.field_date"]             = new() { ["en"] = "Date (BS)",                    ["ne"] = "मिति (वि.सं.)" },
        ["notes.field_text"]             = new() { ["en"] = "Note",                         ["ne"] = "नोट" },
        ["notes.date_required"]          = new() { ["en"] = "Date is required",             ["ne"] = "मिति आवश्यक छ" },
        ["notes.date_invalid"]           = new() { ["en"] = "Invalid date format (YYYY/MM/DD)", ["ne"] = "अमान्य मिति ढाँचा (YYYY/MM/DD)" },
        ["notes.text_required"]          = new() { ["en"] = "Note text cannot be empty",    ["ne"] = "नोट खाली हुन सक्दैन" },
        ["reminders.add"]                = new() { ["en"] = "Add Reminder",              ["ne"] = "रिमाइन्डर थप्नुहोस्" },
        ["reminders.search_hint"]        = new() { ["en"] = "Search reminders...",          ["ne"] = "रिमाइन्डर खोज्नुहोस्..." },
        ["reminders.no_results"]         = new() { ["en"] = "No reminders match your search", ["ne"] = "खोजसँग मिल्ने रिमाइन्डर भेटिएन" },
        ["reminders.form_title_add"]     = new() { ["en"] = "Add Reminder",                 ["ne"] = "रिमाइन्डर थप्नुहोस्" },
        ["reminders.form_title_edit"]    = new() { ["en"] = "Edit Reminder",                ["ne"] = "रिमाइन्डर सम्पादन गर्नुहोस्" },    };
