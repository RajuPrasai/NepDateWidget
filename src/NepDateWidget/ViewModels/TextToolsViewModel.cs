...
public sealed class TextToolsViewModel : ViewModelBase
{
    ...
    {
        get => _pwUpper;
        set { if (SetProperty(ref _pwUpper, value)) GeneratePassword(); }
    }
    ...
    {
        get => _pwLower;
        set { if (SetProperty(ref _pwLower, value)) GeneratePassword(); }
    }
    ...
    {
        get => _pwNumbers;
        set { if (SetProperty(ref _pwNumbers, value)) GeneratePassword(); }
    }
    ...
    {
        get => _pwSymbols;
        set { if (SetProperty(ref _pwSymbols, value)) GeneratePassword(); }
    }
    ...
    {
        get => _pwNepali;
        set { if (SetProperty(ref _pwNepali, value)) GeneratePassword(); }
    }
    ...
    private void GeneratePassword()
    {
        ...
        if (_pwUpper)   charsets.Add(UpperChars);
        if (_pwLower)   charsets.Add(LowerChars);
        if (_pwNumbers) charsets.Add(NumberChars);
        if (_pwSymbols) charsets.Add(SymbolChars);
        if (_pwNepali)  charsets.Add(NepaliChars);
        ...
        {
            if (pos >= (int)_passwordLength) break;
    ...
    {
        if (_unicodeFilePath is null) return;
    ...
    {
        if (_scriptFilePath is null) return;
